...
# Project: From Global to Local — Training-Free MNIST Classification by Normalized Cross-Correlation
...
<p align="center">
  <em>Left: confusion matrix for Method 4 (100 refs / class). &nbsp; Right: Method 5 misclassified samples (true → predicted).</em>
</p>
...
<p align="center">
  <img width="360" alt="DoReMi" src="https://github.com/user-attachments/assets/a1062333-f210-4d11-902c-115cbed0e658" style="margin:0 10px;">
  <img width="360" alt="YunGongXunYin" src="https://github.com/user-attachments/assets/1d843f30-cb55-4c2a-86bf-0a589d01396a" style="margin:0 10px;">
</p>

### Homework 2

A notebook demonstrating the **Nyquist Sampling Theorem** and the **leakage effect**. Shows the derivative and integral of a function with their Fourier Series relationships.

<p align="center">
  <img height="300" alt="Aliasing" src="https://github.com/user-attachments/assets/475d82e5-6c80-41ab-93c0-0e869ff51a36" style="margin:0 10px;" />
  <img height="300" alt="tri_10_integral_Fourier" src="https://github.com/user-attachments/assets/d1059e91-d228-4c7b-b6f7-b030727b7f6a" style="margin:0 10px;" />
</p>
...
Demonstrates that the **Fourier transform of f ∗ g** equals the **product of their transforms** in both continuous and discrete forms, and that the **Laplace transform of f ∗ g** equals the **product of their transforms** in continuous form.
